              ...
              <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '16px', marginBottom: spacing[4] }}>
                ...
                <div className="ds-form-group">
                  ...
                  >
                    ...
                    {showCustomProcedureType && customProcedureType && !['Dynamic ADAS calibration', 'Static ADAS calibration', 'Programming & Coding', 'Key programming', 'New parts adaption', 'Camera Calibration', 'Front Camera Calibration', 'Static Front Camera Calibration', 'Dynamic Front Camera Calibration', 'Dynamic Camera Calibration'].includes(customProcedureType) && (
                      <option value="custom" selected>{customProcedureType}</option>
                    )}
